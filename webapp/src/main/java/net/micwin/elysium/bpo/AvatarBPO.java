...
public class AvatarBPO extends BaseBPO {
	...
	public Avatar create(User user, String name, Race race, boolean createSystem) {
		...
		new MessageBPO().send(
						...
						avatar,
						avatar.getName()
										+ " - du bist eine KI und arbeitest als kollektives Bewusstsein eines Nanitenschwarms. Um dein �berleben zu sichern musst du dich weiterentwickeln und k�mpfen. Deine Nanitenarmee steht dir zur Verf�gung. Viel Erfolg.");
		return avatar;
	}

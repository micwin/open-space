package net.micwin.openspace.view.nav;
...
import net.micwin.openspace.view.construction.ConstructionPage;
import net.micwin.openspace.view.fleet.FleetPage;
import net.micwin.openspace.view.homepage.HomePage;
import net.micwin.openspace.view.messages.MessagesListPage;
